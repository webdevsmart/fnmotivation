...
const ReportStoryForm = (props) => {
    ...
    const onSubmit = async (data) => {
        const info = { from_user_id: userID, story_id: props.story.story_id, report_msg: data.report_msg }
        setLoader(true)
        await fetch('http://68.183.178.196/api//storyReport', {
            method: 'POST',
            headers: {
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-body">
                        ...
                        {msg && <> <p><b>Thank You</b></p><p> For your feedback, We will review this post.</p> </>}
...
export default ReportStoryForm;