...
const ReportStoryCmntReplyForm = (props) => {
    ...
    const onSubmit = async (data) => {
        ...
        setLoader(true)
        await fetch('http://68.183.178.196/api//storyReplyCommentReport', {
            method: 'POST',
            headers: {
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-body">
                        ...
                        {!msg && <p>{props.reply.sc_reply_text}</p>}
...
export default ReportStoryCmntReplyForm;