...
const ArticleCommentReportForm = (props) => {
    ...
    const onSubmit = async (data) => {
        ...
        setLoader(true)
        await fetch('http://68.183.178.196/api//articleCommentReport', {
            method: 'POST',
            headers: {
...
export default ArticleCommentReportForm;